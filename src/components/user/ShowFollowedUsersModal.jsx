...
import { showFollowUser } from "../../redux/action/followActions";
import { Link } from "react-router-dom";

const ShowFollowedUsersModal = ({ userId, show, onClose }) => {
  ...
  return (
    <Modal show={show} onClose={onClose}>
      <Modal.Header>User Followed</Modal.Header>
      <Modal.Body>
...
export default ShowFollowedUsersModal;
